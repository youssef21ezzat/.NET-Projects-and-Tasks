...
namespace StudentPortalWeb.Models
{
    ...
    // =================================================================
    // [Range] is a validation-only attribute. You can prove this to someone by running `dotnet ef migrations add` after adding the attribute; Entity Framework will generate an empty migration because no schema changes were detected.
    public class Student
    {
        ...
        [Range(3.2,4.0,ErrorMessage = "GPA must be between 3.2 and 4.0.")]
